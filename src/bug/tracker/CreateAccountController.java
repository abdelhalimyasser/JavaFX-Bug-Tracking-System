...
public class CreateAccountController implements Initializable {
    ...
    @FXML private RadioButton testerRadio;
    @FXML private RadioButton developerRadio;
    ...
    private String getSelectedRole() {
        if (testerRadio.isSelected()) return "TESTER";
        if (developerRadio.isSelected()) return "DEVELOPER";
        if (pmRadio.isSelected()) return "PROJECT_MANAGER";
